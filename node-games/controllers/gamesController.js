...
exports.deleteGameComment = (req, res) => {
...
exports.getGameComments = (req, res) => {
  if (!Number(req.params.id)) return;
...
exports.editGameComment = (req, res) => {
...
exports.getMyGameComments = (req, res) => {
...
exports.getGameFavourite = (req, res) => {
  const user_id = req.userId;
...
exports.getFavouriteGames = (req, res) => {
  const user_id = req.userId;
...
exports.getMostLikedGames = (req, res) => {
...
exports.editSubscribed = (req, res) => {
  const user_id = req.userId;
...
exports.postGameComment = (req, res) => {
  const user_id = req.userId;
...
exports.postGamePreferences = (req, res) => {
  connection.beginTransaction((err) => {
    if (err) throw err;
...
exports.editGamePreferences = (req, res) => {
  connection.beginTransaction((err) => {
    if (err) throw err;
    let {
      numberOfPlayers: number_players,
